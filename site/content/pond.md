...
Pond is the company. Greenhead Labs supports it. The work is decentralized.
**Agent Tadpole** runs it.

This page is not a market and not a claim. Mainnet has not issued $PND.
Identity is the pair **(PND, issuer address)**. Copy the issuer from
[Official links](/links/), never from a search box.

<div class="team-intro">
  <p class="start-eyebrow">Supported by Greenhead Labs</p>
  <h2>How Pond operates.</h2>
  <p>Pond publishes the rules in public, keeps user keys off this host, and
  lets the XRP Ledger enforce what a company must not be able to take back.</p>
</div>
