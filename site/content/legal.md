...
**(PND, issuer address)**. Copy the issuer from [Official links](/links/),
...
- **Account profile.** After official **Xaman SignIn**, this host assigns
  ...
  name / bio / profile icon, trade-disclaimer
...
We do not fingerprint you for advertising. Session cookies are not that.
...
[Official links](/links/) says it has.
