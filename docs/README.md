...
- **[hosting-decision.md](hosting-decision.md)** — Cloudflare Pages at `pondprotocol.pages.dev`. Verified per-host CORS behaviour, the dashboard settings to paste, and why the website host is not the issuer's on-ledger `Domain`.
